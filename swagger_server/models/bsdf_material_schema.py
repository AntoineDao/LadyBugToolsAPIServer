...
class BSDFMaterialSchema(Model):
    ...
    def xml_data(self) -> str:
        ...
        String of the original XML  # noqa: E501
    ...
    def xml_data(self, xml_data: str):
        ...
        """
        if xml_data is None:
            raise ValueError("Invalid value for `xml_data`, must not be `None`")  # noqa: E501
    ...
    def up_orientation(self, up_orientation: float):
        ...
        :type up_orientation: float
        """
        if up_orientation is None:
            raise ValueError("Invalid value for `up_orientation`, must not be `None`")  # noqa: E501
