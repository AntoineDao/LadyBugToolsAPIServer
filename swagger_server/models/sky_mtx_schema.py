...
class SkyMtxSchema(Model):
    ...
    def sky_density(self, sky_density: int):
        ...
        :type sky_density: int
        """
        if sky_density is None:
            raise ValueError("Invalid value for `sky_density`, must not be `None`")  # noqa: E501
    ...
    def mode(self) -> int:
        ...
        0: total, 1: direct-only, 2: diffuse-only (Default: 0).  # noqa: E501
    ...
    def suffix(self) -> str:
        ...
        Suffix for the sky matrix.The suffix will be added at the end of the standard name.  # noqa: E501
