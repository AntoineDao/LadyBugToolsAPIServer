...
class WeaSchema(Model):
    ...
    def direct_normal_radiation(self, direct_normal_radiation: DataCollectionSchema):
        ...
        if direct_normal_radiation is None:
            raise ValueError("Invalid value for `direct_normal_radiation`, must not be `None`")  # noqa: E501
    ...
    def diffuse_horizontal_radiation(self, diffuse_horizontal_radiation: DataCollectionSchema):
        ...
        if diffuse_horizontal_radiation is None:
            raise ValueError("Invalid value for `diffuse_horizontal_radiation`, must not be `None`")  # noqa: E501
