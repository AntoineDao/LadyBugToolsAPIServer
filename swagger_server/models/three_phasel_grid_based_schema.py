...
class ThreePhaselGridBasedSchema(Model):
    ...
    def sky_mtx(self, sky_mtx: SkyMtxSchema):
        ...
        """
        if sky_mtx is None:
            raise ValueError("Invalid value for `sky_mtx`, must not be `None`")  # noqa: E501
    ...
    def analysis_grids(self, analysis_grids: List[AnalysisGridSchema]):
        ...
        :type analysis_grids: List[AnalysisGridSchema]
        """
        if analysis_grids is None:
            raise ValueError("Invalid value for `analysis_grids`, must not be `None`")  # noqa: E501
    ...
    def surfaces(self, surfaces: List[HBSurfaceSchema]):
        ...
        """
        if surfaces is None:
            raise ValueError("Invalid value for `surfaces`, must not be `None`")  # noqa: E501
    ...
    def analysis_type(self, analysis_type: AnalysisType):
        ...
        if analysis_type is None:
            raise ValueError("Invalid value for `analysis_type`, must not be `None`")  # noqa: E501
    ...
    def view_mtx_parameters(self, view_mtx_parameters: RadianceParameters):
        ...
        :type view_mtx_parameters: RadianceParameters
        """
        if view_mtx_parameters is None:
            raise ValueError("Invalid value for `view_mtx_parameters`, must not be `None`")  # noqa: E501
    ...
    def daylight_mtx_parameters(self, daylight_mtx_parameters: RadianceParameters):
        ...
        :type daylight_mtx_parameters: RadianceParameters
        """
        if daylight_mtx_parameters is None:
            raise ValueError("Invalid value for `daylight_mtx_parameters`, must not be `None`")  # noqa: E501
