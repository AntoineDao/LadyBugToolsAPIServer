...
class TranslucentMaterialSchema(Model):
    ...
    def refraction(self, refraction: float):
        ...
        if refraction is None:
            raise ValueError("Invalid value for `refraction`, must not be `None`")  # noqa: E501
